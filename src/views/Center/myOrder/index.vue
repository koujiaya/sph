    ...
    <div class="order-content">
      ...
      <div class="orders">
        ...
        >
          ...
          <tbody>
            <tr v-for='(detail,index) in record.orderDetailList' :key="detail.skuId">
              <td width="60%">
                <div class="typographic">
                  <img :src="detail.imgUrl" @click=jumpDetail(detail.skuId)>
                  <a class="block-text" @click=jumpDetail(detail.skuId)>{{detail.skuName}}</a>
              ...
              <td :rowspan="record.orderDetailList.length"  v-show='index===0'  width="13%" class="center">
                <ul class="unstyled">
                  <li>总金额{{record.totalAmount|currency('￥')}}</li>
                  <li>{{record.paymentWay|payment}}</li>
                </ul>
              </td>
              <td :rowspan="record.orderDetailList.length"  v-show='index===0'  width="8%" class="center">
                <a class="btn">{{record.orderStatusName}} </a>
              </td>
              <td :rowspan="record.orderDetailList.length"  v-show='index===0'  width="13%" class="center">
                <ul class="unstyled">
                  <li>
